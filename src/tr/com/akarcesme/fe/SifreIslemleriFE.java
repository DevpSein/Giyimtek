			...
			public void actionPerformed(ActionEvent e) {
				...
				if (control == true) {
					...
					if (yetkiBox.getSelectedIndex() == 0
						...
						/*
						prototype hesaplar = new prototype();
						hesaplar.AddPersonel(contract);
						System.out.println(hesaplar.getPersonelListesi());
						
						try {
							prototype hesaplar1 = (prototype) hesaplar.clone();
							List<Object> personeller1 = hesaplar1.getPersonelListesi();
						} catch (CloneNotSupportedException e1) {
							e1.printStackTrace();
						}
						try {
							prototype hesaplar2 = (prototype) hesaplar.clone();
							List<Object> personeller2 = hesaplar2.getPersonelListesi();
							if(yetkiBox.getSelectedIndex() == 2 || yetkiBox.getSelectedIndex() == 4) {
								//personeller2.remove(ABORT);
							}
						} catch (CloneNotSupportedException e1) {
							e1.printStackTrace(); 
						}*/
