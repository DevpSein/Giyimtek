...
public class KategoriDuzenleFE extends JDialog implements FeInterfaces {
	...
	public JPanel initPanel() {
		...
		/*
		 * JList kategoriList = new JList(); kategoriList.setListData(new
		 * KategoriDal().GetAll().toArray()); JScrollPane pane = new
		 * JScrollPane(kategoriList);
		 ...
		 * stub }
		 * 
		 * @Override public void keyReleased(KeyEvent e) { kategoriList.setListData(new
		 * KategoriDal().GetSearchKategori(kategoriAdiField.getText()).toArray());
		 * kategoriList.setSelectedIndex(0); }
		 * 
